...
<div class="row">
    ...
    <div class="col-lg-6">
        <?= $form->field($model, 'input_method')->dropDownList(['الادخال اليدوي', 'نسبه مؤيه']) ?>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <?=
        $form->field($model, 'judiciary_inform_address_id')->widget(kartik\select2\Select2::classname(), [
            'data' => yii\helpers\ArrayHelper::map(JudiciaryInformAddress::find()->all(), 'id', 'address'),
...
<?php if (!Yii::$app->request->isAjax) { ?>
    <div class="form-group">
        ...
        if ($model->isNewRecord) {
            echo             Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create & Print') : Yii::t('app', 'Update & Print'), ['name' => 'print', 'class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']);
        }
        ?>
