...
class LoanSchedulingSearch extends LoanScheduling
{
    ...
    {
        return [
            [['id', 'contract_id', 'status', 'status_action_by', 'created_by', 'last_update_by', 'is_deleted'], 'integer'],
            [['new_installment_date', 'first_installment_date', 'created_at', 'updated_at'], 'safe'],
