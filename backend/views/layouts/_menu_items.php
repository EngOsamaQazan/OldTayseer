...
$mainMenuItems = [
    ...
    [
        'label' => Yii::t('app', 'الصلاحيات'),
        'items' => [

            ['label' => Yii::t('app', 'Permission'), 'icon' => 'dashboard', 'url' => ['/admin/permission'], 'privilege' => Permissions::PERMISSION],
            ['label' => Yii::t('app', 'Role'), 'icon' => 'dashboard', 'url' => ['/admin/role'], 'privilege' => Permissions::ROLE],
            ['label' => Yii::t('app', 'Route'), 'icon' => 'dashboard', 'url' => ['/admin/route'], 'privilege' => Permissions::ROUTE],
            ['label' => Yii::t('app', 'Assignment'), 'icon' => 'dashboard', 'url' => ['/admin/assignment'], 'privilege' => Permissions::ASSIGNMENT],
        ],
    ],
  ...
  ['label' => Yii::t('app', 'Determination'), 'icon' => 'dashboard', 'url' => ['/determination'], 'privilege' => Permissions::DETERMINATION],
    ...
    ['label' => Yii::t('app', 'Installment'), 'icon' => 'dashboard', 'url' => ['/income/income/income-list'], 'privilege' => Permissions::INCOME],
    ['label' => Yii::t('app', 'Employees'), 'icon' => 'dashboard', 'url' => ['/employee/employee'], 'privilege' => Permissions::EMPLOYEE],
   ['label' => Yii::t('app', 'Financial Transaction'), 'icon' => 'dashboard', 'url' => ['/financialTransaction/financial-transaction'], 'privilege' => Permissions::FINANCIAL_TRANSACTION],
    ['label' => Yii::t('app', 'Expenses'), 'icon' => 'dashboard', 'url' => ['/expenses/expenses'], 'privilege' => Permissions::EXPENSES],
    ['label' => Yii::t('app', 'Loan Scheduling'), 'icon' => 'dashboard', 'url' => ['/loanScheduling/loan-scheduling/index'], 'privilege' => Permissions::LOAN_SCHEDULING],
    ['label' => Yii::t('app', 'Notification'), 'icon' => 'dashboard', 'url' => ['/notification/notification/index'], 'privilege' => Permissions::Notification],
